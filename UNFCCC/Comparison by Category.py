base_path = "\\\\10.30.31.77\\data_collection_dump\\RawData\\UNFCCC\\Comparison by Category"
import logging
...
logging.basicConfig(handlers=[logging.FileHandler("\\\\10.30.31.77\\data_collection_dump\\TACFolder\\ScraperLogs\\UNFCCC_Comparison by Category_out.log"),
                        logging.StreamHandler()], level=logging.INFO)
chrome_options = webdriver.ChromeOptions()
base_path = "\\\\10.30.31.77\\data_collection_dump\\RawData\\UNFCCC\\Comparison by Category" # local, gets current working directory
        ...
        if op_2.text == op_1.text :
            ...
            for op_3 in option_list_3:
                ...
                for op_4 in option_list_4:
                    ...
                    for op_5 in option_list_5[0:1]: # always [0:1]
                        select_5.select_by_visible_text(op_5.text)
                        t_5 = op_5.text
                        time.sleep(2)
                        select_7 = Select(select_element7)
                        option_list_7 = select_7.options
                        for op_7 in option_list_7[1:]: 
                            try:
                                select_7.select_by_visible_text(op_7.text)
                                t_7 = op_7.text
                                time.sleep(2)
                                select_6 = Select(select_element6)
                                option_list_6 = select_6.options
                                for op_6 in option_list_6[1:]: 
                                    if op_6.text == op_7.text:
                                        pass
                                    else:
                                        select_6.select_by_visible_text(op_6.text)
                                        t_6 = op_6.text
                                        time.sleep(4)
                                        title = 'Comparison by' + ' ' + t_1 + ' and ' + t_2 + ', ' + t_6 + 'and ' + t_7 + ' ' + t_3 + ' ' + t_4
                                        ...
                                        if file in os.listdir(base_path):
                                            ...
                                            try:
                                                BodyDict = {
                                                "JobPath":f'//10.30.31.77/data_collection_dump/RawData/UNFCCC/Comparison by Category/{title}.xlsx', #* Point to downloaded data for conversion #
                                                "JsonDetails":{
                                                        ## Required
                                                        ...
                                                        "SavePathForJsonOutput": "//10.30.31.77/data_collection_dump/TestData/UNFCCC/Comparison by Category" #* initialise as empty string for production.
                                                    }
                                                }

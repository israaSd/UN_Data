...
def execute():
    ...
    #     if i in range(58,60):
    # for i in range(len(all_li)):
    dataset = driver.find_element(By.CLASS_NAME,'domain-list-container').find_element(By.XPATH,'/html/body/div[2]/div[3]/div/div/div[2]/div/div/div[1]/div/div[14]/ul/li/a')
    # i=58
    if dataset.text == 'SDG Indicators':
        tag = tags[59]
        time.sleep(2)
        dataset = driver.find_element(By.CLASS_NAME,'domain-list-container').find_element(By.XPATH,'/html/body/div[2]/div[3]/div/div/div[2]/div/div/div[1]/div/div[14]/ul/li/a')
        title = dataset.text
